...
using BattleChess3.Core.Figures.FigureTypes.ClassicChess;
using BattleChess3.Core.Figures.FigureTypes.LordOfTheRings;
using BattleChess3.Core.Figures.FigureTypes.Hobbit;
using BattleChess3.Core.Figures.FigureTypes.Silmarillion;
using System.Linq;
