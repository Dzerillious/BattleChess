...
{
    public class LOTRWarrior : SimpleAttackFigure, IFigure
    {
        public string UnitName => "LOTRWarrior";
        ...
        public string PictureBlackPath => Directory.GetCurrentDirectory() + "\\Pictures\\LOTR\\Gothmog.png";
        public string PictureWhitePath => Directory.GetCurrentDirectory() + "\\Pictures\\LOTR\\Gloin.png";
