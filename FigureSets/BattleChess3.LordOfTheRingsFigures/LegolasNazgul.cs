...
namespace BattleChess3.LordOfTheRingsFigures
{
    public class LegolasNazgul : IFigureType
    {
        ...
        public string UnitName { get; } = $"{nameof(LordOfTheRingsFigureGroup)}.{nameof(LegolasNazgul)}";
        ...
        {
            {0, new Uri("pack://application:,,,/BattleChess3.LordOfTheRingsFigures;component/Images/LegolasNazgul1.png", UriKind.Absolute)},
            {1, new Uri("pack://application:,,,/BattleChess3.LordOfTheRingsFigures;component/Images/LegolasNazgul2.png", UriKind.Absolute)},
        };
