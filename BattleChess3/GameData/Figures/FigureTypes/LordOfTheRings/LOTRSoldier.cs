...
namespace BattleChess3.GameData.Figures.FigureTypes.LordOfTheRings
{
    ...
    {
        public string UnitName => "LOTRSoldier";
        ...
        public string PictureBlackPath => Directory.GetCurrentDirectory() + "\\Pictures\\LOTR\\Spider.png";
        public string PictureWhitePath => Directory.GetCurrentDirectory() + "\\Pictures\\LOTR\\Beregond.png";
