...
{
    public class LOTRWizzard : SimpleAttackFigure, IFigure
    {
        public string UnitName => "LOTRWizzard";
        ...
        public string PictureBlackPath => Directory.GetCurrentDirectory() + "\\Pictures\\LOTR\\Witchking.png";
        public string PictureWhitePath => Directory.GetCurrentDirectory() + "\\Pictures\\LOTR\\Gandalf.png";
